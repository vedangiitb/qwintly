...
export default function OrgBilling({
  ...
  return (
   ...
   h-9 rounded-lg
    ...
    >
      <span>
        <Receipt className="w-4 h-4 text-muted-foreground hover:text-foreground transition-colors"></Receipt>
      </span>
      {isExpanded ? (
        <span className="text-sm ml-2 select-none">Billing & Usage</span>
      ) : null}
      <span
