...
type Props = { password: string; setPassword: (val: string) => void; isExistingUser: boolean };

export default function PasswordInput({ password, setPassword, isExistingUser }: Props) {
  ...
  return (
    <div className="relative">
      ...
      {!isExistingUser && tooltipVisible && <PasswordTooltip password={password} />}
    </div>
  );
}
